      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            FilledButton(
              onPressed: () async {
                WeatherAppModal? weatherReport = await WeatherAppServices.makeApiCall("Vijayawada");
                if (weatherReport == null) {
                  debugPrint("City Not found");
                } else {
                  debugPrint(weatherReport.temperature.toString());
                }
              },
              child: Text("sample getting data"),
            ),
          ],
        ),
      ),
